...
setwd("C:/Users/ASUS/Hasibul_statistics Assignment")

# Verify if the file exists
file.exists("C:/Users/ASUS/Hasibul_statistics Assignment")
...
get_salary_wages
# Ensure that salary_wages data has 21 points
...
# If you need exactly 21 observations, you can either take the first 21, sample 21 randomly, or apply some selection method.
# Randomly select 21 observations from the combined data
set.seed(123)  # For reproducibility
salary_wages_sample_21 <-sample(salary_wages_sample, 21, replace = FALSE)
salary_wages_sample_21
# View the sample of 21 observations
print(salary_wages_sample_21)
...
# If you want to take exactly 2 samples, you can sample from combined data
set.seed(123)  # For reproducibility
salary_wages_sample_21 <- sample(combined_salary_wages, 21, replace = FALSE)

# Get frequency distribution for the sample data
frequency_distribution_sample <- get_frequency_distribution(salary_wages_sample_21)

# Print the frequency distribution for the sample
cat("Frequency Distribution for Sample of 21 Observations:\n")
...
# Perform analysis on the 21 sample
print_analysis(salary_wages_sample_21, "Salary Wages Sample of 21 Observations")
...
plot_histogram(frequency_distribution_sample, "Histogram of Salary Wages Sample of 21 Observations")
